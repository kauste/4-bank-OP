...
<?php foreach($list as $key => $item) : ?>
            <form class="saraso-vertes" action="<?= self::DOMAIN . '/list/' . $key?>" method="post"><!-- gerai, kad urlas, o ne path???-->
                    ...
                    <a class="prideti-lesu" href="<?= self::DOMAIN . '/add/' . $key?>">Pridėti lėšų</a>
                    <a class="nuskaiciuoti-lesu" href="<?= self::DOMAIN . '/subtract/' . $key?>">Nuskaičiuoti lėšas</a>
